        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default">
                    <div class="panel-heading">Create your own account</div>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input placeholder="Username" id="name" type="text" class="form-control" name="name"
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <p>Already a member ?<a class="btn btn-link" href="{{ route('login') }}">Sign in</a>
                                    </p>
                                </div>
                            </div>
                        </form>
